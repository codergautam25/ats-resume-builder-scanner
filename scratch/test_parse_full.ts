...
const parsed = parseResumeTextToStructuredData(rawUserText);
const sanitized = sanitizeAndFixResumeData(parsed);

console.log('--- SANITIZED RESULT ---');
console.log('Personal Info:', JSON.stringify(sanitized.personalInfo, null, 2));
console.log('Projects:', JSON.stringify(sanitized.projects, null, 2));
console.log('Certifications:', JSON.stringify(sanitized.certifications, null, 2));
