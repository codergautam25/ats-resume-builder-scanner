...
function stripPdfCoordinateNoise(text) {
  if (!text) return '';
  let cleaned = text;
  ...
  // 2. Strip attached float numbers prefixed to text e.g. 00043.44Indrani, 45.011716Python
...
console.log('--- CLEANED INDRANI TEXT ---');
console.log(stripPdfCoordinateNoise(rawIndraniText));
